...
const universities = graduates.map(graduate => gratuate = graduate.university);
...
displayNames array with only the animal_name and scientific_name of each animal. displayNames will be an
array of strings, and each string should follow this pattern: "Name: Jackal, asiatic, Scientific: Canis aureus."

*/
const displayNames = zooAnimals.map(animal => animal = `Name: ${animal.animal_name}, Scientific: ${animal.scientific_name}.`);
...
const lowCaseAnimalNames = zooAnimals.map(animal => animal = animal.animal_name.toLocaleLowerCase());
